...
Route::get('/chat', [ChatController::class, 'displayChat'])->name('Chat');
Route::post('/chat', [ChatController::class, 'postMessage'])->name('postMessage');
Route::get('/message', [ChatController::class, 'getMessages'])->name('getMessages');
