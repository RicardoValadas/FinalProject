...
<body id=contactBody>
	...
	<div id=contactLogo><img class="contactLogo" src="{{ asset('images/logo.png') }}" alt=""></div>
...
<div>
  <div class="content-contact accordion_inner">
    <ul class="contact-list">
      <li><svg class="icon-svg-use"><use xlink:href="#toko"></use></svg>Luxemburg</li>
      <li>Porte de France 14</li>
      <li>L-4360 Esch-sur-Alzete</li>
      <!-- <li><svg class="icon-svg-use"><use xlink:href="#postcard"></use></svg>Postbox 123</li>
      <li>1234 AB City</li> -->
      <li><svg class="icon-svg-use"><use xlink:href="#call"></use></svg>621 123 456</li>
      <li><svg class="icon-svg-use"><use xlink:href="#email"></use></svg>safe4net@support.lu</li>
...
<div id=contactGif><img src="{{ asset('images/contactfooter.gif') }}" alt=""></div>
</main>
