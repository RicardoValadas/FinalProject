  ...
  <div>
    <div class="content-contact accordion_inner">
      <ul class="contact-list">
        ...
        <li><svg class="icon-svg-use">
            <use xlink:href="#website"></use>
          </svg><a href="https://www.linkedin.com/in/gabriel-silva-webdev/" target="_blank">https://www.linkedin.com/in/gabriel-silva-webdev/</a></li>
      </ul>
  ...
  <div>
    <div class="content-contact accordion_inner">
      <ul class="contact-list">
        ...
        <li><svg class="icon-svg-use">
            <use xlink:href="#website"></use>
          </svg><a href="https://www.linkedin.com/in/ricardovaladas/" target="_blank">https://www.linkedin.com/in/ricardovaladas/</a></li>
      </ul>
    </div>
  </div>
  ...
  <div>
    <div class="content-contact accordion_inner">
      <ul class="contact-list">
        ...
        <li><svg class="icon-svg-use">
            <use xlink:href="#website"></use>
          </svg><a href="https://www.linkedin.com/in/soares-danilo/" target="_blank">https://www.linkedin.com/in/soares-danilo/</a></li>
      </ul>
  ...
  <div>
    <div class="content-contact accordion_inner">
      <ul class="contact-list">
        ...
        <li><svg class="icon-svg-use">
            <use xlink:href="#website"></use>
          </svg><a href="https://www.linkedin.com/in/wildsonalves/" target="_blank">https://www.linkedin.com/in/wildsonalves/</a></li>
      </ul>
    </div>
  </div>
