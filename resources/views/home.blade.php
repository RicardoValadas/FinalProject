...
@section('style')
<link rel="stylesheet" class="logo" href="{{ URL::asset('/css/home_page/home_page.css') }}">
@endsection

@section('content')

<img class="logoHome" src="{{ asset('images/logo2.png') }}" alt="">
...
<a href="quiz" class="playquiz">Play the Quiz!</a>
